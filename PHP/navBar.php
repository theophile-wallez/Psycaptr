...
function displayNavBar(string $url=""){
    ...
    echo '<a class="header-link Acceuil" href="'.$url.'index#" draggable="false">Accueil</a>';
    echo '<a class="header-link Tests" href="'.$url.'index#test-section" draggable="false">Tests</a>';
    echo '<a class="header-link FAQ" href="'.$url.'index#FAQ-link" draggable="false">FAQ</a>';
    echo '<a class="header-link Contact" href="'.$url.'index#contact_link" draggable="false">Contact</a>';
    echo '</div>';
