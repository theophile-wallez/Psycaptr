  ...
  <div class="dashboard_container">
    ...
    <div class="line-container">
      ...
      <div class="line-container">
        ...
        <a href="http://projets-tomcat.isep.fr:8080/appService/?ACTION=COMMAND&TEAM=G9Dy&TRAME=1G9Dy25010000FEDC15" target="theframe" onclick="window.open('attenteTest')" class="test-container" draggable="false">
          <div class="testIcon-container">
