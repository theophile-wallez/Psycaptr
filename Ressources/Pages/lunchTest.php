...
<!-- <iframe width=1000 height=1000 marginwidth=0 marginheight=0 frameborder=0 name="theframe" src="http://stackoverflow.com/" ></iframe> -->
  ...
  <div class="dashboard_container">
    ...
    <div class="line-container">
        <a class="test-container" href="http://projets-tomcat.isep.fr:8080/appService/?ACTION=COMMAND&TEAM=G9Dy&TRAME=1G9Dy23010000FEDC15" onclick="window.open('attenteTest')" >
